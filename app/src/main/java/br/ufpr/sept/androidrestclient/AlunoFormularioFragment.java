...
import br.ufpr.sept.androidrestclient.services.BuscaCEPRequestTask;
                ...
                new BuscaCEPRequestTask(){
                    ...
                    protected void onPostExecute(EnderecoBuscaCEP endereco) {
                        if(endereco != null){
                            ...
                            Toast.makeText(getActivity().getApplicationContext(), "CEP não encontrado", Toast.LENGTH_LONG).show();
                        }
                    }
                }.execute(cep);
            }
